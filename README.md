# DigiCert Script Examples
* [Automating User Access](https://github.com/remorseville/digicert_scripts)



# April 2020
Going a different route I've decided to see what was possible using Flask to build my app. ([https://flask.palletsprojects.com/en/1.1.x/](https://flask.palletsprojects.com/en/1.1.x/)). I'd like the most modern looking UI possible and Flask ties in HTML, jQuery and JavaScript. The UI options basically open up to to anything web development has to offer. It's a huge difference. 

I'm not looking to create a website, but turn the project into a local running app similar to what Electron can provide. I have some of the basic back end proof of concept done and started to work on the UI as well. Here's a pic! 

![https://i.ibb.co/r0BDBT2/chrome-c-Lc-M05-T7-Wh.jpg](https://i.ibb.co/r0BDBT2/chrome-c-Lc-M05-T7-Wh.jpg)


# DigiCert Client Certificate Manager - April 2020
